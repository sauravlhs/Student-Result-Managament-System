    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Engagement</h4>
              ...
              <CRow>
                <CCol xs="12" md="6" xl="6">
                  ...
                  <CRow>
                    <CCol sm="6">
                      <CCallout color="info">
                        <small className="text-muted">HoD</small>
                        <br />
                    ...
                    <CCol sm="6">
                      <CCallout color="danger">
                        <small className="text-muted">Proffessor</small>
                        <br />
                        <strong className="h4">64</strong>
                      </CCallout>
                    </CCol>
                  </CRow>
                  ...
                  <CRow>
                    <CCol sm="6">
                      <CCallout color="warning">
                        <small className="text-muted">Asst. Professor</small>
                        <br />
                        <strong className="h4">154</strong>
                      </CCallout>
                    </CCol>
                    <CCol sm="6">
                      <CCallout color="success">
                        ...
                        <br />
                        <strong className="h4">394</strong>
                      </CCallout>
                    </CCol>
                  </CRow>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div className="small text-muted">
                        <span>New</span> | Registered: July 6, 2018
                      </div>
                    </td>
                    <td className="text-center">
                      <CIcon height={25} name="cif-in" title="us" id="in" />
                    </td>
                    <td>
                      <div className="clearfix">
                        ...
                        <div className="float-right">
                          <small className="text-muted">April 1, 2021 -  31, 2021</small>
                        </div>
                      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div className="small text-muted">
                        ...
                        <span>Recurring</span> | Registered: Jan 1, 2019
                      </div>
                    </td>
                    <td className="text-center">
                      <CIcon height={25} name="cif-in" title="br" id="in" />
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Mudit Jain</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: Feb 1, 2015
                      </div>
                    </td>
                    <td className="text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      <div>Surendra Das</div>
                      <div className="small text-muted">
                        <span>New</span> | Registered: Jan 1, 2015
                      </div>
                    </td>
                    <td className="text-center">
                      <CIcon height={25} name="cif-in" title="fr" id="in" />
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <CIcon height={25} name="cif-in" title="es" id="in" />
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
